...
Since training data consists of isolated clips rather than continuous musical streams, synthetic sequences were generated by:

1. Concatenating isolated gesture clips with short neutral pauses between notes
2. Deriving heuristic temporal labels — onset (attack), sustain (central), amplitude (normalised ASR envelope)
3. Ensuring dataset splits were defined **before** stream construction to prevent data leakage

| Segment | Onset | Sustain | Amplitude | State |
|---|---|---|---|---|
| Attack portion | 1 | 0 | ASR ramp-up | Active |
| Steady portion | 0 | 1 | ASR peak | Active |
| Pause segment | 0 | 0 | 0 | Inactive |

<p align="center">
  <img src="assets/data_collection.png" width="700" alt="Data Collection and Synthetic Stream"/>
  <br/>
